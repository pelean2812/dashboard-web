...
with col2:
    ...
    """)
st.markdown("Após isso, as diversas informações destes dataframes foram cruzadas a fim de se obter um único datframe contendo apenas os registros dos discentes do curso de direito da UFRN. As duas imagens abaixo ilustram o processo de junção.")
col1, col2, col3 = st.columns([1, 6, 1])
with col2:
...
st.markdown("Este dataframe possui a estrutura desejada, porém, ele ainda contém os registros de todos os discentes da UFRN, então, este dataframe é filtrado buscando apenas os discentes cujo identificador do curso é 2000018, que é o identificador do curso de direito da UFRN. Após isso, é gerado um dataframe com estes registros e um arquivo .csv contendo estes registros, que agora ocupa apenas 16.8MB de espaço e possui apenas 175550 registros.")
st.header("Estrutura curricular do curso de direito da UFRN")
st.text("A imagem abaixo ilustra a estrutura curricular 04A do curso de direito da UFRN, que corresponde a estrutura vigente entre os períodos de 2011.1 e 2024.2 na UFRN.")
